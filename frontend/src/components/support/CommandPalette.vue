...
const STATIC_PAGES = [
  ...
  { label: 'Flashcards', path: '/user/flashcards', icon: 'lucide:layers' },
  { label: 'Study goals', path: '/user/goals', icon: 'lucide:target' },
  { label: 'Leaderboard', path: '/user/leaderboard', icon: 'lucide:trophy' },
