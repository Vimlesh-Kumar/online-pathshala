...
// Upstream is authored for Nuxt, which auto-imports these.
...
// shallowRef, not ref: a deep ref's UnwrapRef mangles the MotionValue type and
// <Motion :style> then rejects it.
